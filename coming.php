...
<div class="loginbox radius">
  ...
  <h2 style="color:#141823; text-align:center;">Upcoming B'days</h2>

  <div class="loginboxinner radius">

    <div class="loginheader">

      <h4 class="title">Plan out a party!!</h4>
      ...
      <?php
		...
		while($f_num=mysqli_fetch_assoc($r1)){
			...
			?>
				...
				<button type="submit" class="radius title" name="<?php echo $fid;?>" style="width:250px;">Plan for Party</button></form>
				</div>
			<?php
			}
