...
<div id="mySidenav" class="sidenav">
  ...
  <a href="cspass.php" id="secret">ChangePass</a>
  <a href="homepage.php" id="logout">Logout</a>
</div>

<div class="loginbox radius">

  <h2 style="color:#141823; text-align:center;">Keep it secret</h2>
  ...
  <div class="loginboxinner radius" id="co">
    ...
    <div class="loginform" id="limitco">
      ...
      <?php
		//echo $id;
		//print_r($names);
		$q1="SELECT sid,chat,time from smessage where sid=$fid and rid=$id UNION SELECT sid,chat,time from smessage where sid=$id and rid=$fid order by time";
		//echo "hello";
		$r1=mysqli_query($con,$q1);
		//echo "hello";
